...
public class AAOSCameraApiManager extends CameraDevice.StateCallback {

  private final String TAG = "AAOSCameraApiManager";
  ...
  public AAOSCameraApiManager(Context context) {
  ...
  public void prepareCamera(SurfaceTexture surfaceTexture, int width, int height, int fps) {
    Size optimalResolution = Camera2ResolutionCalculator.INSTANCE.getOptimalResolution(new Size(width, height), getCameraResolutions(cameraId));
    ...
    try {
      ...
      cameraDevice.createCaptureSession(listSurfaces, new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
          AAOSCameraApiManager.this.cameraCaptureSession = cameraCaptureSession;
          try {
  ...
  public void openCameraId(String cameraId) {
    ...
    if (prepared) {
      ...
      try {
        ...
        running = true;
        if (cameraCallbacks != null) {
          cameraCallbacks.onCameraChanged(Facing.FRONT);
        }
      ...
      Log.e(TAG, "AAOSCameraApiManager need be prepared, AAOSCameraApiManager not enabled");
    }
  }
